...
export var wallSound = new soundFile("mixkit-game-ball-tap-2073.wav"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("tap-resonant.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("spacePongWall.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("cinematic-space-drone-10623.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -20; //turn down volume

export var adventureMusic = new soundFile("cinematic-space-drone-10623.mp3");
