...
export var wallSound = new soundFile("spacePongWall.mp3"); //load sound
...
export var ambientSound = new soundFile("cinematic-space-drone-10623.mp3.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -20; //turn down volume

export var adventureMusic = new soundFile("cinematic-space-drone-10623.mp3.mp3");
